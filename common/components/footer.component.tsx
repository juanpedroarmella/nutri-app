...
export function Footer() {
  return (
    <footer className='w-full relative flex flex-col sm:flex-row items-center justify-between border-t text-center text-[10px] gap-4 py-4 px-6 text-muted-foreground mt-10 sm:mt-0'>
